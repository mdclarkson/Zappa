...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝     ╚═╝  ╚═╝\n""",
        ...
        default_bucket = "zappa-" + "".join(secrets.choice(string.ascii_lowercase + string.digits) for _ in range(9))
        while True:
...
"""
    ...
    def load_settings(self, settings_file=None, session=None):
        ...
        self.s3_bucket_name = self.stage_config.get(
            "s3_bucket",
            "zappa-" + "".join(secrets.choice(string.ascii_lowercase + string.digits) for _ in range(9)),
        )
